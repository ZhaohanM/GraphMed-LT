...
def get_args():
    ...
    parser.add_argument('--self_consistency', type=int, default=3, help='Number of times to run the self-consistency check.')
    # parser.add_argument('--abstain_threshold', type=float, default=0.8, help='Threshold for abstaining from making a choice.')
    parser.add_argument('--abstain_threshold',type=int,  default=5, help='Confidence score (1-5) below which the model abstains.')
